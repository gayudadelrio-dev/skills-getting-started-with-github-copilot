...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practices and matches for competitive soccer",
    ...
    "Drama Club": {
        "description": "Acting, stage design, and theater production",
    ...
    "Debate Team": {
        "description": "Learn debate skills and participate in tournaments",
